...
void bzf_dynamic_array_get_ptr(struct bzf_dynamic_array dynamic_array, size_t index, void **out);

void bzf_dynamic_array_get(struct bzf_dynamic_array dynamic_array, size_t index, void *out);
...
void bzf_dynamic_array_get_back(struct bzf_dynamic_array dynamic_array, void *out);
